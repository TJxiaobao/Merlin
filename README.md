...
- ✏️ **实时编辑** - 在浏览器中像 Excel 一样手动修改数据，支持保存回服务器 ⭐️ 新
...
### ✅ v0.0.6（当前版本）
- **实时编辑器** ✏️ ⭐️ 新
  - 内嵌 Handsontable 表格组件
  - 支持在浏览器中直接修改 Excel 数据
  - 修改后自动保存到服务器，下载即为最新数据
  - 完美支持 "AI 处理 + 人工微调" 的协同工作流
...
- **配置完全外部化** 🎯
  ...
  - 智能路由配置 → `merlin_v1.yml` (intelligent_routing)
